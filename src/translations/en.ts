export default {
	...
	"updated_at": "2023-04-11T08:31:06Z",
	"source_locale": null,
	...
	"keys": {
		...
		"active_label": "Active",
		"actor_label": "Actor",
		"addAliasUserDisabled_msg": "The email alias could not be added to the user or group because the user is currently deactivated.",
		...
		"alreadyTemplateGroupMember_msg": "You are already using this template group. You'll have to remove yourself from the group before you can accept this invitation.",
		...
		"businessDeletionWarning_msg": "The business feature  will be deactivated for all users now. Autoresponders and calendar invites will be disabled. Only one custom email domain is allowed.",
		...
		"clickHereForMoreInfo_msg": "Click here for more information",
		...
		"configureCustomDomainAfterSignup_msg": "Custom domains can be configured once the account is created:\n",
		...
		"confirmLeaveTemplateGroup_msg": "Are you sure you want to stop using this template list? The owner would have to re-invite you.",
		...
		"declineTemplateGroupEmailBody_msg": "Hello {recipientName}, <br/>{invitee} has declined your invitation to use the template list \"{groupName}\".<br/><br/>This is an automated message.",
		...
		"deletionWarning_msg": "Please note: Free accounts will be deleted if they are not used for more than six months. Accounts of paying users are never deleted. Read more on what you get with our paid subscriptions:\n",
		...
		"ordertItNow_msg": "Would you like to order the feature now?",
		"order_action": "Order",
		...
		"priceOfferEnded_label": "The special offer has ended. Please book Tutanota at the standard prices.",
		...
		"pricing.comparisonSharingCalendar_msg": "Share entire calendars",
		...
		"pricing.management_tooltip": "Reset passwords and second factors of users, create aliases for users, deactivate users and more.",
		...
		"removeTemplateGroupMemberConfirm_msg": "Are you sure you want to remove {member} as a user of the template list \"{groupName}\"?",
		...
		"sharingFeatureNotOrderedUser_msg": "To share a calendar you have to order the sharing feature.",
		...
		"takeoverMailAddress_label": "Optional: Target account address",
		...
		"templateSharingNotOrdered_msg": "To share a template list, you need to have the Sharing feature. Do you want to order it now?",
		...
		"terminationSubject_msg": "Termination of your account",

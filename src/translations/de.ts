export default {
	...
	"updated_at": "2023-04-13T14:38:40Z",
	"source_locale": {
	...
	"keys": {
		...
		"active_label": "Aktiv",
		"actor_label": "Akteur",
		"addAliasUserDisabled_msg": "Der E-Mail-Alias konnte dem Benutzer bzw. der Gruppe nicht hinzugefügt werden, weil der Benutzer deaktiviert ist.",
		"addCalendar_action": "Kalender hinzufügen",
		"addCustomDomainAddresses_title": "Hinzufügen von E-Mail-Adressen",
		"addCustomDomainAdresses_msg": "Die Domain wurde für dein Konto registriert. Um sie benutzen zu können, füge mindestens einen Alias hinzu. Alternativ kannst du neue Benutzer für die Domain anlegen.",
		...
		"alreadyTemplateGroupMember_msg": "Du verwendest diese Vorlagengruppe bereits. Du musst dich erst aus der Gruppe entfernen, bevor du diese Einladung annehmen kannst.",
		...
		"businessCustomerAutoBusinessFeature_msg": "Beachte, dass das Business-Feature automatisch mit allen Abonnements für Geschäftskunden gebucht wird.",
		"businessCustomerNeedsBusinessFeaturePlan_msg": "Dein aktuelles Abonnement ist {plan} ({price}) ohne das Business-Feature.",
		...
		"businessFeatureRequiredMultipleDomains_msg": "Um mehrere eigene Domains hinzuzufügen, musst du das Business-Feature buchen.",
		"businessFeatureRequiredTemplates_msg": "Um Vorlagen zu verwenden, buche bitte zuerst das Business-Feature.",
		...
		"clickHereForMoreInfo_msg": "Klicke hier für mehr Informationen.",
		...
		"confirmLeaveTemplateGroup_msg": "Bist du sicher, dass du diese Vorlagenliste nicht mehr verwenden möchtest? Der Ersteller der Liste müsste dich erneut einladen.",
		...
		"customTemplateListName_label": "Dein benutzerdefinierter Name der Volagenliste: {customName}",
		...
		"declineTemplateGroupEmailBody_msg": "Hallo {recipientName}, <br/>{invitee} hat  deine Einladung zur Verwendung der Vorlagenliste \"{groupName}\" abgelehnt.<br/><br/>Dies ist eine automatische Nachricht.",
		...
		"deleteAllEventRecurrence_action": "Alle Ereignisse löschen",
		...
		"deleteSingleEventRecurrence_action": "Nur dieses Ereignis löschen",
		...
		"deleteTemplateGroup_msg": "Möchtest du die Vorlagen-Gruppe löschen?",
		...
		"deletionWarning_msg": "Bitte beachte: Kostenlose Konten werden gelöscht, wenn sie länger als sechs Monate nicht benutzt werden. Bezahlte Konten werden nicht gelöscht. Lies hier, welche Vorteile du mit unseren bezahlten Abonnements bekommst:\n\n",
		...
		"ordertItNow_msg": "Möchtest du das Feature jetzt buchen?",
		"order_action": "Buchen",
		...
		"priceOfferEnded_label": "Das Angebot ist nicht mehr gültig. Bitte buche Tutanota zum normalen Preis.",
		...
		"pricing.addUsers_tooltip": "Administriere dein Team, setze Passwörter und zweite Faktoren zurück, definiere Adminsitratorrollen und manage alle Buchungen und die Abrechnung zentral.",
		"pricing.admin_label": "Administrationskonsole",
		"pricing.admin_tooltip": "Administrationskonsole zur Verwaltung deines Teams, zum Zurücksetzen von Passwörtern und zweiten Faktoren, zur Definition mehrerer Administratorrollen und zur zentralen Abrechnung.",
		...
		"pricing.comparisonDomainBusiness_tooltip_markdown": "<p>Verwende deine eigenen E-Mail-Domainadressen (name@deinunternehmen.de)</p>\n",
		...
		"pricing.management_tooltip": "Setze Passwörter und zweite Faktoren zurück, erstelle Aliase, deaktiviere Benutzer*innen und vieles mehr.",
		...
		"pricing.offline_tooltip": "Zugriff auf deine E-Mails, Kalender und Kontakte, wann und wo immer du bist - auch ohne Internetverbindung; verfügbar mit allen Tutanota Apps für Desktop, Android & iOS.",
		...
		"removeTemplateGroupMemberConfirm_msg": "Möchtest du {member} als Benutzer der Vorlagenliste \"{groupName}\" wirklich entfernen?",
		...
		"selectRecipientCountry_msg": "Wähle das Land der Empfangsadresse aus",
		...
		"shareTemplateGroupWarning_msg": "Alle Benutzer der Vorlagenliste können deinen Namen und die Haupt-Mail-Adresse deiner Mailbox sehen.",
		...
		"sharingFeatureNotOrderedAdmin_msg": "Zum Freigeben eines Kalenders muss die Freigeben-Funktion gebucht werden. Möchtest Du die Funktion jetzt buchen?",
		...
		"takeoverSuccess_msg": "Du kannst jetzt deine E-Mail-Adresse in dem angegebenen Account als E-Mail-Alias oder Benutzer wiederverwenden.",
		...
		"templateSharingNotOrdered_msg": "Um die Vorlagenliste zu teilen, benötigst du die Freigeben-Funktion. Möchtest du diese jetzt buchen?",
		...
		"terminationSubject_msg": "Kündigung deines Accounts",
		...
		"tooManyCustomDomains_msg": "Du hast zu viele eigene Domains. Wenn das Business-Feature abbestellt wird, ist nur eine eigene Domain verfügbar.",
		...
		"welcomeMailBody_markdown": "**Willkommen in deiner sicheren, grünen und werbefreien Tutanota-Mailbox, geschützt durch starke Verschlüsselung.**\n\nTutanota macht den Umstieg von anderen E-Mail-Diensten einfach: Unsere intuitiven Apps für Android & iOS sowie unsere Desktop-Apps für Windows, macOS und Linux ermöglichen dir den Zugriff auf dein sicheres Postfach und deinen Kalender selbst dann, wenn du offline bist. Wenn du noch eine alte E-Mail-Adresse hast, empfehlen wir, die automatische Weiterleitung in deinem alten Konto einzurichten und alle E-Mails und Kontakte mit der Zeit auf Tutanota umzustellen.\n\nLies [hier]({faqForwardLink}), wie du deine E-Mails an Tutanota weiterleiten kannst.\n\nSobald du alle wichtigen Konversationen zu Tutanota übertragen hast, kannst du die automatische Weiterleitung wieder deaktivieren. Auf diese Weise bekommst du bei Tutanota eine schöne, saubere und spamfreie Mailbox!\n\n**Tutanota basiert auf 4 Prinzipien, um eine privatsphäre-freundliche Alternative zu Big Tech anzubieten.**\n\n1. Tutanota trackt dich nicht.\n2. Tutanota kann deine Daten nicht scannen.\n3. Tutanota verschlüsselt alle E-Mails, Kontakte & Termine.\n4. Tutanota basiert auf dem Ansatz \"Privacy by Design\".\n\n**Liebst du Tutanota schon? Bitte bewerte unsere Android & iOS Apps!**\n\nHerzlichen Dank,\\\ndein Tutanota-Team\n\n**Alle verdienen Privatsphäre.**\n\nDu kannst uns unterstützen, indem du uns auf unseren Social-Media-Kanälen folgst und unsere Beiträge mit deinem Bekanntenkreis teilst. Gemeinsam werden wir das Internet zum Besseren verändern!\n\n* [LinkedIn]({linkedinLink})\n* [Facebook]({facebookLink})\n* [Mastodon]({mastodonLink})\n* [Twitter]({twitterLink})\n* [Reddit]({redditLink})\n* [Instagram]({instagramLink})\n* [YouTube]({youtubeLink})\n\nTutanota ist Open Source. [Du kannst den Code hier einsehen und analysieren]({githubLink}).",
